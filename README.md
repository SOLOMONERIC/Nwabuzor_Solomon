...
![Portfolio Demo](https://i.postimg.cc/ZnGfKJ7h/solomon.png)
...
[**Live Demo**](https://solomon-eric.vercel.app)
---
### 🎯 Project Structure
```bash
portfolio/
...
2. After forking, open your terminal and run the following commands to clone the repo:
  ...
  ```bash
  git clone https://github.com/SOLOMONERIC/Nwabuzor_Solomon
  ```
...
<div align="center"> Made with ❤️ Nwabuzor Solomon Eric </div>
